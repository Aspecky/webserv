...
class RequestHandler {
  ...
  private:
	...
	void handleGet_(const HttpRequest &req, const LocationConfig &loc,
					...
					bool withBody);
	void handleDirectoryGet_(const HttpRequest &req, const LocationConfig &loc,
							 HttpResponse &res, const std::string &fullPath,
							 bool withBody);
	void handleFileGet_(const LocationConfig &loc, HttpResponse &res,
						const std::string &fullPath, bool withBody);
	std::string resolvePath_(const std::string &root, const std::string &uri,
	...
	void handleMultipart_(const HttpRequest &req, const LocationConfig &loc,
						  HttpResponse &res);
	bool saveUploadedFile_(const std::string &uploadStore,
